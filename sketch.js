...
function draw() {
  ...
  if(jackson.isTouching(powerUpGroup))
  {
     ...
     backgrounds.velocityX=-(backgrounds.velocityX+2)
     obstacleGroup.setVelocityXEach(obstacles.velocityX+2)
  }
 ...
 //
  ...
  textSize(20)
  fill("cyan")
  text( "Coins Collected: "+coinCount,1250,50)
  text("Distance Coverd: "+ score,1250,70)
...
function obstacle()
{
  ...
  var rand = Math.round(random(1,3));
    ...
    obstacles.setCollider("rectangle",0,0,500,100);
